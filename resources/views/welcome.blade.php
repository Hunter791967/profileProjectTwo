...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('first/styles/normalize.css') }}">
    <link rel="stylesheet" href="{{ asset('first/styles/first.css') }}">
...
<body>
    <div class="main_box">
        <div class="log_links">
            {{-- <a class="english arabic_link" href="index-ar.html" target="_blank">
                <img src="{{ asset('images/icons8-english-to-arabic-32.png') }}" alt="English To Arabic" width="30px">
            </a> --}}
            @if (Route::has('login'))
        ...
        <div class="section_one">
            <div class="ecf_title">MY PROFILE PROJECT<small>...USING LARAVEL</small></div>
        </div>
    </div>
