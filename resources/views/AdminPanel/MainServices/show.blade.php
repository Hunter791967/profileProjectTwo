...
@section('page_title')
    @lang('app.SHOW') @lang('app.MAIN') @lang('app.SERVICES')
@endsection

@section('content')
    <div class="card">
        <div class="card-header showCard-Header">
            <h6>@lang('app.SHOWING ALL') @lang('app.MAIN') @lang('app.SERVICES')</h6>
            {{-- @if (Auth::user()->hasPermission('users-create')) --}}
            <button type="button" class="btn btn-block btn-primary add_btn"><a class="formButton"
                    href="{{ url('/mainService/create') }}">@lang('app.ADD')</a></button>
            {{-- @else
                        ...
                        <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" role="grid"
                            ...
                            <thead>
                                <tr role="row">
                                    ...
                                    <th class="sorting_asc" tabindex="0" aria-controls="example1" rowspan="1"
                                        colspan="1" aria-sort="ascending"
                                        aria-label="Rendering engine: activate to sort column descending">@lang('app.MAIN')
                                        @lang('app.IMAGE')
                                    </th>
                                    <th class="sorting_asc" tabindex="0" aria-controls="example1" rowspan="1"
                                        colspan="1" aria-sort="ascending"
                                    ...
                                    <th class="sorting_asc" tabindex="0" aria-controls="example1" rowspan="1"
                                        colspan="1" aria-sort="ascending"
                                        aria-label="Rendering engine: activate to sort column descending">@lang('app.SUB')
                                        @lang('app.DESC')
                                    </th>
                                    <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1"
                            ...
                            <tbody class="tbody_font">
                                @foreach ($showData as $singleData)
                                    <tr role="row" class="odd">
                                        ...
                                        <td>{{ $singleData->main_title }}</td>
                                        <td>{{ $singleData->sub_title }}</td>
                                        <td class="disp_center">
                                            <img class="profile-user-img img-fluid img-circle usr_img"
                                                src="{{ asset('uploads/mainServices/' . $singleData->main_image) }}"
                                                alt="Main Service picture">
                                        </td>
                                        <td>{{ $singleData->main_desc }}</td>
                                        <td>{{ $singleData->sub_desc }}</td>
                                        <td class="option_ud col_width">
                                            {{-- @if (Auth::user()->hasPermission('users-delete')) --}}
                                            <a href="{{ url("/mainService/$singleData->id") }}"
                                            ...
                                            <a href="{{ route('mainService.edit', ['mainService' => $singleData->id]) }}"
                                                type="submit"
                                                class="btn
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <th rowspan="1" colspan="1">@lang('app.MAIN') @lang('app.TITLE')</th>
                                    <th rowspan="1" colspan="1">@lang('app.SUB_TITLE')</th>
                                    <th rowspan="1" colspan="1">@lang('app.MAIN') @lang('app.IMAGE')</th>
                                    <th rowspan="1" colspan="1">@lang('app.MAIN') @lang('app.DESC')</th>
                                    <th rowspan="1" colspan="1">@lang('app.SUB') @lang('app.DESC')</th>
