...
@section('page_title')
    @lang('app.DELETE') @lang('app.MAIN') @lang('app.SERVICE')
@endsection
...
@section('content')
    ...
    <div class="card card-primary">
        ...
        <!-- /.card-header -->
        <!-- form start -->
        <form role="form" action="{{ route('mainService.destroy', ['mainService' => $mainService->id]) }}" method="post">
            @csrf
            @method('DELETE')
            <div class="card-body">
            ...
            <div class="card-footer">
                ...
                <a href="{{ url('/mainService') }}" class="btn btn-success">CANCEL</a>
            </div>
        </form>
    </div>
    <!-- /.card -->
