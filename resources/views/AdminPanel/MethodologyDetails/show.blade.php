...
@section('page_title')
    @lang('app.SHOW') @lang('app.METHODOLOGY') @lang('app.DETAILS')
@endsection

@section('content')
    <div class="card">
        <div class="card-header showCard-Header">
            <h6>@lang('app.SHOWING ALL') @lang('app.METHODOLOGY') @lang('app.DETAILS')</h6>
            {{-- @if (Auth::user()->hasPermission('users-create')) --}}
            <button type="button" class="btn btn-block btn-primary add_btn"><a class="formButton"
                    href="{{ url('/methodologyDetail/create') }}">@lang('app.ADD')</a></button>
            {{-- @else
                        ...
                        <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" role="grid"
                            ...
                            <thead>
                                <tr role="row">
                                    ...
                                    <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1"
                                        colspan="1" aria-label="Browser: activate to sort column ascending">
                                        @lang('app.METHODOLOGY') @lang('app.DESC')
                                    </th>
                                    <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1"
                                    ...
                                    <tr role="row" class="odd">
                                        ...
                                        <td>
                                            <img class="profile-user-img img-fluid img-circle usr_img"
                                                src="{{ asset('uploads/methodologyDetails/' . $singleData->icon_image) }}"
                                                alt="Methodology Detail Icon">
                                        </td>
                                        <td>{{ $singleData->methodology_desc }}</td>
                                        <td class="option_ud col_width">
                                            {{-- @if (Auth::user()->hasPermission('users-delete')) --}}
                                            <a href="{{ route('methodologyDetail.show', $singleData->id) }}"
                                            ...
                                            <a href="{{ route('methodologyDetail.edit', ['methodologyDetail' => $singleData->id]) }}"
                                                type="submit"
                                                class="btn
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <th rowspan="1" colspan="1">@lang('app.ICON')</th>
                                    <th rowspan="1" colspan="1">@lang('app.METHODOLOGY') @lang('app.DESC')</th>
