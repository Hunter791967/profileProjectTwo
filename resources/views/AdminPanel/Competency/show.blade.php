...
@section('page_title')
    @lang('app.SHOW') @lang('app.COMPETENCY')
@endsection

@section('content')
    <div class="card">
        <div class="card-header showCard-Header">
            <h6>@lang('app.SHOWING ALL') @lang('app.COMPETENCIES')</h6>
            {{-- @if (Auth::user()->hasPermission('users-create')) --}}
            <button type="button" class="btn btn-block btn-primary add_btn"><a class="formButton"
                    href="{{ url('/competency/create') }}">@lang('app.ADD')</a></button>
            {{-- @else
                                ...
                                @foreach ($showData as $singleData)
                                    <tr role="row" class="odd">
                                        ...
                                        <td class="option_ud col_width">
                                            ...
                                            <a href="{{ route('competency.show', $singleData->id) }}"
                                            ...
                                            <a href="{{ route('competency.edit', ['competency' => $singleData->id]) }}"
                                                type="submit"
                                                class="btn
