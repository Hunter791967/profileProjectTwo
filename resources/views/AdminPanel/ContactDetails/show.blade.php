...
@section('page_title')
    @lang('app.SHOW') @lang('app.CONTACT')
@endsection

@section('content')
    <div class="card">
        <div class="card-header showCard-Header">
            <h6>@lang('app.SHOWING ALL') @lang('app.CONTACT')</h6>
            {{-- @if (Auth::user()->hasPermission('users-create')) --}}
            <button type="button" class="btn btn-block btn-primary add_btn"><a class="formButton"
                    href="{{ url('/contactDetail/create') }}">@lang('app.ADD')</a></button>
            {{-- @else
                        ...
                        <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" role="grid"
                                ...
                                @foreach ($showData as $singleData)
                                    <tr role="row" class="odd">
                                        ...
                                        <td class="option_ud col_width">
                                            ...
                                            <a href="{{ route('contactDetail.show', $singleData->id) }}"
                                            ...
                                            <a href="{{ route('contactDetail.edit', ['contactDetail' => $singleData->id]) }}"
                                                type="submit"
                                                class="btn
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <th rowspan="1" colspan="1">@lang('app.ADRESS')</th>
