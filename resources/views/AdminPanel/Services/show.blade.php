                        ...
                        <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" role="grid"
                            ...
                            <thead>
                                <tr role="row">
                                    ...
                                    <th class="sorting_asc" tabindex="0" aria-controls="example1" rowspan="1"
                                        colspan="1" aria-sort="ascending"
                                        aria-label="Rendering engine: activate to sort column descending">@lang('app.SERVICE')
                                        @lang('app.IMAGE')
                                    </th>
                                    <th class="sorting_asc" tabindex="0" aria-controls="example1" rowspan="1"
                                        colspan="1" aria-sort="ascending"
                                        aria-label="Rendering engine: activate to sort column descending">@lang('app.ICON')
                                        @lang('app.IMAGE')
                                    </th>
                                    <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1"
                                        colspan="1" aria-label="Platform(s): activate to sort column ascending">
                                        @lang('app.SERVICES') @lang('app.TAB')
                                    </th>
                                    <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1"
                                    ...
                                    <tr role="row" class="odd">
                                        ...
                                        <td class="disp_center">
                                            <img class="profile-user-img img-fluid img-circle usr_img"
                                                src="{{ asset('uploads/services/' . $singleData->service_image) }}"
                                                alt="Service picture">
                                        </td>
                                        <td>
                                            <img class="profile-user-img img-fluid img-circle usr_img"
                                                src="{{ asset('uploads/services/' . $singleData->icon_image) }}"
                                                alt="Icon picture">
                                        </td>
                                        <td>{{ $singleData->service_tab }}</td>

                                        <td class="option_ud col_width">
                                            {{-- @if (Auth::user()->hasPermission('users-delete')) --}}
                                            <a href="{{ url("/service/$singleData->id") }}"
                                            ...
                                            <a href="{{ route('service.edit', ['service' => $singleData->id]) }}"
                                                type="submit"
                                                class="btn
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <th rowspan="1" colspan="1">@lang('app.SERVICE') @lang('app.IMAGE')</th>
                                    <th rowspan="1" colspan="1">@lang('app.ICON') @lang('app.IMAGE')</th>
                                    <th rowspan="1" colspan="1">@lang('app.SERVICE') @lang('app.TAB')</th>
