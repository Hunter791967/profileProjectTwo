                        ...
                        <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" role="grid"
                                ...
                                @foreach ($showData as $singleData)
                                    <tr role="row" class="odd">
                                        ...
                                        <td class="option_ud col_width">
                                            ...
                                            <a href="{{ route('prospectDetail.show', $singleData->id) }}"
                                            ...
                                            <a href="{{ route('prospectDetail.edit', ['prospectDetail' => $singleData->id]) }}"
                                                type="submit"
                                                class="btn
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <th rowspan="1" colspan="1">@lang('app.PHONE')</th>
                                    <th rowspan="1" colspan="1">@lang('app.MESSAGE')</th>
...
@endsection
@section('page_title', 'PROSPECT DETAILS')
@section('page_style')
    <!-- DataTables -->
