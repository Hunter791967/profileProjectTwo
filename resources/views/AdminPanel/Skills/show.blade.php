                        ...
                        <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" role="grid"
                            ...
                            <tbody class="tbody_font">
                                @foreach ($showData as $singleData)
                                    <tr role="row" class="odd">
                                        ...
                                        <td>{{ $singleData->skill_rate }}</td>
                                        <td class="option_ud col_width">
                                            {{-- @if (Auth::user()->hasPermission('users-delete')) --}}
                                            <a href="{{ route('skill.show', $singleData->id) }}"
                                            ...
                                            <a href="{{ route('skill.edit', ['skill' => $singleData->id]) }}" type="submit"
                                                class="btn
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <th rowspan="1" colspan="1">@lang('app.SKILL_RATE')</th>
